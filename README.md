...
*   **Organic Feel:** Borders and UI elements mimic woodblock frame lines.
*   **Hanko Selection:** Selection color is inspired by the red ink of an artist's signature stamp.
*   **Sumi-e Syntax:** Comments are italicized to mimic hand-written calligraphy, while Classes and Constants are bolded to provide structural "outlines".
